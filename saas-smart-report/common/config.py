...
class Settings(BaseSettings):
    ...
    oidc_issuer: str = Field(default="dev", alias="OIDC_ISSUER")
    oidc_audience: str = Field(default="srw", alias="OIDC_AUDIENCE")
    oidc_client_id: str = Field(default="srw-dev", alias="OIDC_CLIENT_ID")
    jwt_dev_bearer: str = Field(default="devtoken-please-dont-use-in-prod", alias="JWT_DEV_BEARER")
    ...
    srw_temperature: float = Field(default=0.1, alias="SRW_TEMPERATURE")
